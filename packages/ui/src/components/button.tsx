...
const variantClassMap: Record<ButtonVariant, string> = {
  primary:
    'bg-[var(--primary,#cba670)] text-[var(--primary-foreground,#fff)] hover:bg-[var(--primary-hover,#b8955c)] active:bg-[var(--primary-active,#a8844f)] shadow-[var(--shadow-xs,0_1px_2px_rgba(0,0,0,0.04))]',
  secondary:
...
const sizeClassMap: Record<ButtonSize, string> = {
  sm: 'h-8 gap-1.5 px-3 text-xs rounded-[var(--radius-md,0.5rem)]',
  md: 'h-9 gap-2 px-4 text-sm rounded-[var(--radius-lg,0.625rem)]',
  lg: 'h-10 gap-2 px-5 text-sm rounded-[var(--radius-lg,0.625rem)]',
};
