    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        {needsNationalId ? (
          ...
          <div>
            <Label>کد ملی</Label>
            <p className="mt-2 font-mono text-sm text-stone-700" dir="ltr">
              {data.kyc.nationalId}
            </p>
          </div>
        ) : null}
      ...
      <div className="border-t border-border pt-6">
        <h4 className="text-sm font-semibold text-stone-900">آدرس ارسال</h4>
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            {form.formState.errors.line1 ? (
              <p className="mt-1 text-xs text-rose-600">{form.formState.errors.line1.message}</p>
            ) : null}
          </div>
          <div>
      ...
      {canWrite ? (
        ...
        <p className="text-sm text-stone-500">شما مجوز ویرایش اطلاعات کاربر را ندارید.</p>
      )}
    </form>
  );
}
